...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" required placeholder="Mailinizi giriniz">
      ...
      <input type="submit" name="submit" value="Şimdi Kaydolun" class="form-btn">
      <p>Zaten bir hesabınız var mı? <a href="login_form.php">Giriş yapın</a></p>
   </form>
